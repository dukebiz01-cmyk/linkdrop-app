...
const ARTICLES: Article[] = [
  ...
  // PG1 — 헥토 심사 요구(이용약관 내 환불 규정 기재). 아래 2줄은 PG사 제시 원문 그대로 —
  //   자구 변형 금지. 이번 추가 범위는 심사 요구분(휴대폰 결제 취소·환불)에 한정하며,
  //   결제수단별 환불 조문 전문은 추후 정책서 v1에서 보강 예정(법무 검수 포함).
  {
    title: "제16조 (휴대폰 결제의 취소 및 환불)",
    blocks: [
      {
        kind: "ul",
        items: [
          "휴대폰 결제의 경우, 당월은 결제 취소만 가능합니다.",
          "익월 이후 환불 요청 시, 휴대폰 요금 납부 확인 후 결제자 본인 계좌로만 환불 가능합니다.",
        ],
      },
    ],
  },
  {
    title: "부칙",
    blocks: [
      { kind: "p", text: `이 약관은 2026년 6월 18일부터 시행합니다.` },
      // PG1-b — 제16조(휴대폰 결제 취소·환불) 신설에 따른 개정 시행일. 기존 시행일 줄 무수정 유지.
      { kind: "p", text: `이 약관은 2026년 8월 15일부터 개정 시행합니다(제16조 신설).` },
    ],
  },
];
