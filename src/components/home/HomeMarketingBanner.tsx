...
// LINGO-UI-2a — onStart/open("시작해 볼까요" CTA) 폐지: 링고 아코디언 자체 헤더가 단독 수행.
export function HomeMarketingBanner() {
  ...
  return (
    <section className="mb-5">
      ...
      {/* LINGO-UI-2a — "시작해 볼까요" CTA(구 링고 펼침 신호) 제거: 바로 아래 링고 아코디언
          헤더와 역할 이중 — 배너 카드(데모·씬 도트)는 Duke 락대로 원형 보존. */}
    </section>
  );
}
